...
namespace qt_test
{
    ...
    class qt_node : public rclcpp::Node{
        ...
        public:
            ...
            KFRAME generateSampleKFrame(const c_point& p1, const c_point& p2, const c_point& p3, const c_point&p4,const c_point&p5,const c_point&p6,const c_point&p7 );
